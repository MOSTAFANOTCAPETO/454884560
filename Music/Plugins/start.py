...
def start_pannel():
    buttons = [
        ...
        [
            InlineKeyboardButton(text=f"ℹ️ | الاوامر", url=f"https://telegra.ph/klaer-05-15"),
        ],
    ]
    return (
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [        
            InlineKeyboardButton(text=f"⏏️ | بوت السورس", url=f"https://t.me/KLAERmusic7bot"),
            InlineKeyboardButton(text=f"🚸 | الــــمطور", url=f"https://t.me/mostafa_3w"),
        ],
        [
            InlineKeyboardButton(text=f"👥 | التواصل", url=f"https://t.me/{GROUP}"),
            InlineKeyboardButton(text=f"⏺️ | قناه السورس", url=f"https://t.me/{CHANNEL}"),
        ...
        [        
            InlineKeyboardButton(text=f"M U S T A F A𓁷", url=f"https://t.me/mostafa_3w"),
        ],
    ]
)
        ...
        try:
            ...
            if member.id == BOT_ID:
                ...
                await message.reply_text(
                    f"""**[👋](https://telegra.ph/file/130807f4863c6cd3b2bce.jpg)
...
async def play(_, message: Message):
    if len(message.command) == 1:
        ...
        await app.send_message(
            message.chat.id,
            text=f"""**
[𝐖𝐞𝐥𝐜𝐨𝐦 𝐓𝐨 𝐦𝐮𝐬𝐢𝐜  ｋｌａｅｒ](https://telegra.ph/file/a7d4219016b38254e8803.jpg)
ꔹ━━ꔹ━ꔹ━━ꔹꔹ━━ꔹ━ꔹ━━ꔹ
〉 ♬ 𝐝𝐞𝐯 𝐦𝐮𝐬𝐢𝐜 : [M U S T A F A𓁷](https://t.me/mostafa_3w)
〉 ♬ 𝐦𝐮𝐬𝐢𝐜 ｋｌａｅｒ : [𝐦𝐮𝐬𝐢𝐜 ｋｌａｅｒ](https://t.me/sasa_boody)
〉 ♬ 𝐓𝐖𝐒𝐎𝐋 : [𝐆𝐑𝐎𝐔𝐏 𝐓𝐖𝐒](t.me/sasa_body1)
 ꔹ━━ꔹ━ꔹ━━ꔹꔹ━━ꔹ━ꔹ━━ꔹ**""",
            parse_mode="markdown",
