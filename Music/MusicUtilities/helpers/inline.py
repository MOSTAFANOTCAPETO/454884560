...
start_keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "📚 الاوامر​ 📚", url="https://telegra.ph/klaer-05-15"
            )
        ],
...
def start_pannel():
    ...
    if not CHANNEL and GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="- TWS ROOM -", url=f"https://t.me/{GROUP}"
                ),
            ],
        ]
    ...
    if CHANNEL and not GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="- CH MUSIC -", url=f"https://t.me/{GROUP}"
                ),
            ],
        ]
        return f"🎛  **This is {MUSIC_BOT_NAME}**", buttons
    if CHANNEL and GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="- CH MUSIC -", url=f"https://t.me/{CHANNEL}"
                ),
                InlineKeyboardButton(
                    text="- TWS ROOM -", url=f"https://t.me/{GROUP}"
                ),
